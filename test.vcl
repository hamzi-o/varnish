...
backend illchinomeals { 
      .host = "135.148.103.238";
      .port = "80";
      .host_header = "illchinomeals.com";
}
...
sub vcl_recv {
  ...
  if (req.http.host ~ "^(www\.)?illchinomeals\.com$") {
    set req.http.host = "illchinomeals.com";
    set req.backend_hint = illchinomeals;
  }
    elseif (req.http.host ~ "^(www\.)?204mealprep\.com$")  {
      set req.http.host = "204mealprep.com";
      set req.backend_hint = mealprep204;
    }
